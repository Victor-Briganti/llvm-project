...
/// This represents '#pragma omp for approx' directive.
///
/// \code
/// #pragma omp for approx private(a,b) reduction(+:c,d)
/// \endcode
/// In this example directive '#pragma omp for approx' has clauses 'private'
/// with the variables 'a' and 'b' and 'reduction' with operator '+' and
/// variables 'c' and 'd'.
///
class OMPForApproxDirective : public OMPLoopDirective {
  friend class ASTStmtReader;
  friend class OMPExecutableDirective;
  /// Build directive with the given start and end location.
  ///
  ...
  /// \param CollapsedNum Number of collapsed nested loops.
  ///
  OMPForApproxDirective(SourceLocation StartLoc, SourceLocation EndLoc,
                      unsigned CollapsedNum)
      : OMPLoopDirective(OMPForApproxDirectiveClass, llvm::omp::OMPD_for_approx,
  ...
  /// \param CollapsedNum Number of collapsed nested loops.
  ///
  explicit OMPForApproxDirective(unsigned CollapsedNum)
      : OMPLoopDirective(OMPForApproxDirectiveClass, llvm::omp::OMPD_for_approx,
                         SourceLocation(), SourceLocation(), CollapsedNum) {}
...
public:
  ...
  /// \param NumClauses Number of clauses.
  ///
  static OMPForApproxDirective *CreateEmpty(const ASTContext &C,
                                          unsigned NumClauses,
                                          unsigned CollapsedNum, EmptyShell);

  static bool classof(const Stmt *T) {
    return T->getStmtClass() == OMPForApproxDirectiveClass;
  }
};
